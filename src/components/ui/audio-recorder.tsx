...
import { AudioModule, RecordingOptions, RecordingPresets, setAudioModeAsync, useAudioRecorder } from 'expo-audio';
import { Circle, Mic, Send, Square, Trash2 } from 'lucide-react-native';
...
export function AudioRecorder({
  ...
  const secondaryColor = useColor("primaryLight");
  const textColor = useColor('text');
  const mutedColor = useColor('textMuted');
  const redColor = useColor('red');
  const greenColor = useColor("primary");
        ...
        <View style={{ alignItems: 'center' }}>
          ...
          <View style={styles.playbackControls}>
            ...
            >
              ...
              <Text style={{ color: 'white', marginLeft: 8 }}>Send to AI</Text>
            </Button>
          </View>
        </View>
      ) : (
        <View>
          ...
          {showTimer && (
            <View style={styles.timerContainer}>
              ...
              {maxDuration && (
                <Text variant='caption' style={{ color: mutedColor, fontWeight: '500' }}>
